            ...
            <div className="container">
                <div className="row">
                    <div className="item about">
                        <img onClick={() => scrollToTarget("header")} src='/images/nav_logo.webp'
                    ...
                    <div className="item links">
                        <h2>Služby</h2>
                        <button onClick={() => scrollToTarget("services")}>Asfaltování</button>
                        <button onClick={() => scrollToTarget("services")}>Zhutnění</button>
                    </div>
                    <div className="item links">
                        <h2>Kontaktujte nás</h2>
                        <a href='tel:721605620' target='_blank' rel="noopener noreferrer"><img
                            src='/images/footerphone.svg' alt='Telefonní číslo redesigner' draggable="false"
                            loading="lazy" placeholder="blur"/> +420 721 605 620</a>
                        <a href='mailto:komunikace-vysocina@seznam.cz' target='_blank' rel="noopener noreferrer"><img
                            src='/images/footeremail.svg' className="footer-email" alt="" draggable="false"
                            loading="lazy"
                            placeholder="blur"/> komunikace-vysocina@seznam.cz</a>
                    </div>
                </div>
